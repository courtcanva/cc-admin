...
const CourtSchema = Yup.object().shape({
  ...
  height: Yup.number().integer().positive().min(0).required("Required"),
  length: Yup.number().integer().positive().min(0).required("Required"),
  width: Yup.number().integer().positive().min(0).required("Required"),
  centreCircleRadius: Yup.number().integer().positive().min(0).required("Required"),
  lengthOfCorner: Yup.number().integer().positive().min(0).required("Required"),
  lineBorderWidth: Yup.number().integer().positive().min(0).required("Required"),
  restrictedAreaLength: Yup.number().integer().positive().min(0).required("Required"),
  restrictedAreaWidth: Yup.number().integer().positive().min(0).required("Required"),
  sideBorderWidth: Yup.number().integer().positive().min(0).required("Required"),
  threePointLine: Yup.number().integer().positive().min(0).required("Required"),
  threePointRadius: Yup.number().integer().positive().min(0).required("Required"),
